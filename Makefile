...
Transmition: clean transmitter.o
	g++ -pthread transmitter.o Reading_file.o TextCoder.o Coder.o Modulation.o Writing.o INIReader.o ini.o Transmitter.o -o TRANSMITION

main.o: main.cpp
	g++ -c main.cpp

transmitter.o: Transmition/transmitter.cpp
	g++ -c Transmition/transmitter.cpp Transmition/Reading_file.cpp Transmition/Coder.cpp Transmition/TextCoder.cpp Transmition/Modulation.cpp Transmition/Writing.cpp Transmition/INIReader.cpp Transmition/ini.c Transmition/Transmitter.cpp
